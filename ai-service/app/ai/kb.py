...
DEFAULT_KB = [
    ...
    },
    {
        ...
        'content': (
            ...
            'Liên hệ support@shopsphere.vn để được hỗ trợ.'
        ),
    ...
    },
    {
        ...
        'content': (
            'ShopSphere hỗ trợ các phương thức thanh toán: '
    ...
    },
    {
        ...
        'content': (
            'Để đăng ký tài khoản ShopSphere: '
    ...
    {
        'category': 'general',
        'title': 'Giới thiệu ShopSphere',
        'content': (
            'ShopSphere là cửa hàng trực tuyến đa ngành, cung cấp hàng nghìn sản phẩm '
            'thuộc các nhóm: sách, điện tử, thời trang, nhà bếp, thể thao, đồ chơi. '
            'Chúng tôi cam kết mang đến trải nghiệm mua sắm tốt nhất với giá cả hợp lý.'
        ),
        'keywords': ['shopsphere', 'giới thiệu', 'about', 'cửa hàng', 'marketplace'],
    },
]
