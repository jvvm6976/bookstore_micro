...
def run(csv_path: str | Path | None = None, seed: int | None = None) -> dict:
    ...
    model = GRUClassifier(input_dim=feature_dim, hidden_dim=64, num_layers=1, num_classes=NUM_CLASSES)
    return train_classifier(model, split_data, "gru", "gru", artifacts_dir)
